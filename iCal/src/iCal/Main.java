...
public class Main {
  ...
  private static void writeIcs(Event e) throws IOException
  {
    ...
    pw.println("DTSTART:20150708T000000");//start time
    pw.println("DTEND:20150708T010000");//end time
    pw.println("DTSTAMP:20150708T055708");//time stamp
    pw.println("UID:tb863cq76eqdncengt90o41ioo@google.com");//need unique id
    pw.println("CLASS:" + e.getClassType());//classification 
    pw.println("CREATED:20150707T015617");//time stamp
    pw.println("DESCRIPTION:" + e.getDescription());//description
    pw.println("LAST-MODIFIED:20150708T055519");//time stamp
